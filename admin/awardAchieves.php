...
<div id="wrapper">
	...
	<div id="page" class="container">
		...
		<?php if($_SESSION['isAdmin'] >= 3){ ?>
			...
			<h1 style="text-align:center">Award an Achievement</h1><br/><br/>
			<br/><h2 style="text-align:center">Achievements for an individual player</h1><br/>
			...
			<br/><h2 style="text-align:center">Achievements for a group of players (Web Committee Only)</h1><br/>
