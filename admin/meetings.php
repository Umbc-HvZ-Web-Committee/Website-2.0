...
<div id="wrapper">
	...
	<div id="page" class="container">
		...
		<?php if($_SESSION['isAdmin'] >= 2){ ?>
			...
			<form action="" method="post"><p>
				Remember that today's date is appended to the meeting name. Meetings will have "[Admin]" or "[Mission]" at the beginning of the name.<br/>
				...
				<label for="mission"><input type="radio" name="meetingType" value="mission" id="mission" checked="checked"/>HvZ Mission</label><br/>
