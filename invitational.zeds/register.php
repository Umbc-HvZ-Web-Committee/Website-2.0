...
mysql_query("INSERT INTO `users` (`UID`, `uname`, `passwd`, `email`, `isAdmin`, `fname`, `lname`, `SID`, `isOver18`, `hasTurnedInWaiver`, `phoneNumber`, `housing`, `medicalConcerns`, `roommateRequest`, `emergencyContactName`, `emergencyContactRelation`, `emergencyContactPhone`) "
."VALUES ('$uid', '$user', '$pass', '$email', '0', '$fname', '$lname', '$schoolID', '$isOld', '$hasTurnedInWaiver', '$phone', '$isHousing', '$medical', '$roommates', '$emergencyName', '$emergencyRelation', '$emergencyPhone');");
echo mysql_error();
?>
