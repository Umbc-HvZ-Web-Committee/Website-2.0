			...
			if(isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] >= -1) { //This is here to easily restrict access to the page. Just change the -1 to 1 or 2 to restrict.
				if($playerData){
					...
					*/
					...
					$total = $ret['appearancesThisTerm'] + rand(-69, 69);
					$zombie = $ret['zombieStartsThisTerm'] + rand(-69, 69);
					$human = $ret['humanStartsThisTerm'] + rand(-69, 69);
					$mod = $ret['gamesModdedThisTerm'] + rand(-69, 69);
					$admins = $ret['adminMeetingsThisTerm'] + rand(-69, 69);
					...
					$total = $ret['appearancesTotal'] + rand(-420, 420);
					$zombie = $ret['zombieStartsTotal'] + rand(-420, 420);
					$human = $ret['humanStartsTotal'] + rand(-420, 420);
					$mod = $ret['gamesModdedTotal'] + rand(-420, 420);
					...
					$sum = ($currentSemesterCount + $lastSemesterCount) * rand(1, 42);
